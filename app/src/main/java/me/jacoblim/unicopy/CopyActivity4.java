...
public class CopyActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btPrevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CopyActivity4.this, CopyActivity3.class);
        ...
        btNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CopyActivity4.this, CopyActivity5.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(CopyActivity4.this, "Copied!", Toast.LENGTH_SHORT).show();
            }
        });
