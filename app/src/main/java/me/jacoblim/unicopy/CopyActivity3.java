...
public class CopyActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btPrevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CopyActivity3.this, CopyActivity2.class);
        ...
        btNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CopyActivity3.this, CopyActivity4.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(CopyActivity3.this, "Copied!", Toast.LENGTH_SHORT).show();
            }
        });
